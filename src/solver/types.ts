...
export interface PipelineTask { id:string; title:string; objective:string; responsibility:string; nonGoals:string[]; techniqueIds:string[]; knowledgeGrounding:KnowledgeGrounding; prerequisiteTaskIds:string[]; recommendedSoftwareId:string|null; softwareLabel:string; softwareAgnostic:boolean; method:ExecutionMethod; methodLabel:string; resourceIds:string[]; estimatedHumanMinutes:number; estimatedLearningMinutes:number; estimatedAgentMinutes:number; whyIncluded:string; definitionOfDone:string[]; agentDelegation:AgentDelegationGuide|null }
